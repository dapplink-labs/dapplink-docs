...
import { g as glob, c as createMarkdownRenderer, f as fs, m as matter, a as getDefaultExportFromCjs } from './serve-CbSpHz5m.js';
export { S as ScaffoldThemeType, b as build, p as createServer, e as defineConfig, h as defineConfigWithTheme, d as defineLoader, n as init, j as mergeConfig, r as resolveConfig, l as resolvePages, k as resolveSiteData, i as resolveUserConfig, s as scaffold, o as serve } from './serve-CbSpHz5m.js';
...
function createContentLoader(pattern, {
  ...
  if (!config) {
    throw new Error(
      "content loader invoked without an active dapplink-docs process, or before dapplink-docs config is resolved."
    );
  }
